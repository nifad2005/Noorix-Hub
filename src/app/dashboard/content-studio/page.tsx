...
import { Loader2, PlusCircle, AlertCircle, Inbox, Lightbulb, ListRestart, BotMessageSquare } from "lucide-react";
import type { IContentHandle } from "@/models/ContentHandle";
import { ContentHandleCard } from "@/components/content-studio/ContentHandleCard";
    ...
    <PageWrapper>
      <div className="space-y-8">
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight font-headline">Content Studio</h1>
